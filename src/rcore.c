...
static void RecordAutomationEvent(void)
{
    ...
    for (int id = 0; id < MAX_TOUCH_POINTS; id++)
    {
            ...
            ((int)CORE.Input.Touch.position[id].y != (int)CORE.Input.Touch.previousPosition[id].y))
        {
            ...
            currentEventList->events[currentEventList->count].param0 = id;
            currentEventList->events[currentEventList->count].param1 = (int)CORE.Input.Touch.position[id].x;
            currentEventList->events[currentEventList->count].param2 = (int)CORE.Input.Touch.position[id].y;
